-- CreateEnum
CREATE TYPE "Status" AS ENUM ('PUBLISHED', 'PENDING', 'SUSPENDED');
...
CREATE TABLE "Vendor" (
    ...
    "vendorPercentage" DOUBLE PRECISION DEFAULT 30.0,
    "phone" TEXT,
    "address" TEXT,
...
-- AddForeignKey
ALTER TABLE "VendorEarning" ADD CONSTRAINT "VendorEarning_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
